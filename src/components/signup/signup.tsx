...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      localStorage.setItem('Udata', response.data.data)
      console.log('Signup attempted with:', formData, id);
      navigate('/rooms')
    ...
    <div className="signupContainer">
      <div className="signupWrapper">
        <div className="signupCard">
          ...
          <div className="signupBrandSection">
            <div className="brandContent">
              ...
              <h1 className="brandTitle">Join Our Community</h1>
          ...
          <div className="signupFormSection">
            <div className="formHeader">
              ...
              <p className="formSubtitle">Fill in your details to get started</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="signupForm" noValidate>
              ...
              {submitError && (
                <div className="errorMessage">
                  ...
                  <span className="errorText">{submitError}</span>
                </div>
              )}
              ...
              <div className="inputGroup">
                ...
                <div className={`inputWrapper ${errors.username && touched.username ? 'inputError' : ''}`}>
                  ...
                  {formData.username && !errors.username && (
                    <span className="fieldSuccess">✓</span>
                  )}
                </div>
              ...
              <div className="inputGroup">
                ...
                <div className={`inputWrapper ${errors.email && touched.email ? 'inputError' : ''}`}>
                  <span className="inputIcon">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="inputGroup">
                ...
                <div className={`inputWrapper ${errors.password && touched.password ? 'inputError' : ''}`}>
                  <span className="inputIcon">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="socialButtons">
                ...
                <button type="button" className="socialButton githubButton">
                  <svg width="20" height="20" viewBox="0 0 20 20">
